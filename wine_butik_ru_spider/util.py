...
VINTAGE1_XPATH = "//div[contains(@class, 'prod_param_2')]/.//option[@selected]/text()"
VINTAGE2_XPATH = "//div[contains(@class, 'prod_param_2')]/p/em[contains(text(), 'Год')]/../text()"
...
def image_url_conver(base_url, image_url):
    if image_url:
        # -- выделим path
